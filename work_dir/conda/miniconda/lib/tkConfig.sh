...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/tmp/miniconda_temp/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/tmp/miniconda_temp/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/tmp/miniconda_temp/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/tmp/miniconda_temp/lib/libtkstub8.6.a'
