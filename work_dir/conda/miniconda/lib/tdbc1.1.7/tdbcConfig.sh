...
# dir.
tdbc_LIB_SPEC="-L/tmp/miniconda_temp/lib/tdbc1.1.7 -ltdbc1.1.7"
TDBC_LIB_SPEC="-L/tmp/miniconda_temp/lib/tdbc1.1.7 -ltdbc1.1.7"
...
# String to pass to the linker to pick up the TDBC stub library from its
# installed directory
tdbc_STUB_LIB_SPEC="-L/tmp/miniconda_temp/lib/tdbc1.1.7 -ltdbcstub1.1.7"
TDBC_STUB_LIB_SPEC="-L/tmp/miniconda_temp/lib/tdbc1.1.7 -ltdbcstub1.1.7"
...
tdbc_STUB_LIB_PATH="/tmp/miniconda_temp/lib/tdbc1.1.7/libtdbcstub1.1.7.a"
TDBC_STUB_LIB_PATH="/tmp/miniconda_temp/lib/tdbc1.1.7/libtdbcstub1.1.7.a"
...
# headers
tdbc_INCLUDE_SPEC="-I/tmp/miniconda_temp/include"
TDBC_INCLUDE_SPEC="-I/tmp/miniconda_temp/include"
...
tdbc_LIBRARY_PATH="/tmp/miniconda_temp/lib/tdbc1.1.7"
TDBC_LIBRARY_PATH="/tmp/miniconda_temp/lib/tdbc1.1.7"
