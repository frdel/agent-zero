set -gx CONDA_EXE "/tmp/miniconda_temp/bin/conda"
set _CONDA_ROOT "/tmp/miniconda_temp"
set _CONDA_EXE "/tmp/miniconda_temp/bin/conda"
set -gx CONDA_PYTHON_EXE "/tmp/miniconda_temp/bin/python"
