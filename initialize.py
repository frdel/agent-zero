def initialize():
    ...
    # chat_llm = models.get_openai_chat(model_name="openai/gpt-4o-mini", temperature=0)
    ...
    chat_llm = models.get_openrouter(model_name="openai/gpt-4o-mini")
    ...
    config = AgentConfig(
        ...
        code_exec_docker_ports={"22/tcp": 50022},  # Added missing comma here
        code_exec_docker_volumes={files.get_abs_path("work_dir"): {"bind": "/root", "mode": "rw"}},  # Added missing comma here
